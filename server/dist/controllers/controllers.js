...
const ALL_MOVIES = path_1.default.resolve(__dirname, "../data/AllMovies.json");
const BollywoodMovies = path_1.default.resolve(__dirname, "../data/BollywoodMovies.json");
const NowPlayingMovies = path_1.default.resolve(__dirname, "../data/NowPlayingMovies.json");
const PopularMovies = path_1.default.resolve(__dirname, "../data/PopularMovies.json");
const TamilMovies = path_1.default.resolve(__dirname, "../data/TamilMovies.json");
const TelguMovies = path_1.default.resolve(__dirname, "../data/TelguMovies.json");
const TopRatedMovies = path_1.default.resolve(__dirname, "../data/TopRatedMovies.json");
const UpcomingMovies = path_1.default.resolve(__dirname, "../data/UpcomingMovies.json");
// ----------------------------------- --------------------------------
const roomModel_1 = __importStar(require("../models/roomModel"));
// importing uuid for random ID generation
const uuid_1 = require("uuid");
const notificationModel_1 = __importDefault(require("../models/notificationModel"));
const MovieCastDetails_json_1 = __importDefault(require("../data/MovieCast/MovieCastDetails.json"));
const MovieDetails_json_1 = __importDefault(require("../data/MovieDetails/MovieDetails.json"));
...
const viewFollowingsHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { userID } = req.params;
        // finding if the user the user exists or not
        const user = yield userModel_1.default.findById(userID).populate('following', 'name email image');
...
const fetchUserByID = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield userModel_1.default.findById(userID).select("email name image").exec();
...
const createRoomHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const activeRooms = yield roomModel_1.default.find({
            hostUserId: userID,
            status: "active",
        });
        ...
        const movieDetails = new roomModel_1.MovieModel({
            movieID,
            movieName,
            movieLink,
        });
...
const fetchMovieCastHandler = (req, res) => {
    try {
        const movieId = parseInt(req.params.movieId);
        // Find the movie cast details based on the movie ID
        const castDetails = MovieCastDetails_json_1.default.find((movie) => movie.id === movieId);
        if (castDetails) {
...
exports.fetchMovieCastHandler = fetchMovieCastHandler;
// endpoint for fetching the movie details
const fetchMovieDescriptionHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const movieId = parseInt(req.params.movieId);
        // Find the movie cast details based on the movie ID
        const castDetails = MovieDetails_json_1.default.find((movie) => movie.id === movieId);
        if (castDetails) {
            res.status(200).json(castDetails);
        }
        else {
...
exports.fetchMovieDescriptionHandler = fetchMovieDescriptionHandler;
// endpoint for searching the movies
const getSearchMovieHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const filePath = path_1.default.resolve(__dirname, "../data/AllMovies.json");
        // console.log('filePaths', filePath);
        // Read the JSON file synchronously and parse it into an object
        const moviesData = JSON.parse(fs.readFileSync(filePath, "utf8"));
        // console.log('moviesData', moviesData);
        const results = moviesData.results.filter((movie) => movie.title.toLowerCase() === searchQuery);
        if (results.length === 0) {
...
exports.getSearchMovieHandler = getSearchMovieHandler;
...
const sendMessage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield (0, authService_1.sendMessageToRecipient)(senderId, recipientId, messageType, messageText, imageUrl);
        res
            .status(200)
...
const getUserDetails = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield (0, authService_1.getUserDetailsService)(userId);
        if (response) {
            res.json(response);
        }
    }
...
const fetchChats = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const message = yield (0, authService_1.fetchChatsService)(senderId, recepientId);
        res.json(message);
    }
    catch (error) {
...
const deleteMessage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const message = yield (0, authService_1.deleteMessages)(messages);
        if (message) {
