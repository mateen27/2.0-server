...
router.get("/search-movie/:title", controllers_1.getSearchMovieHandler);
// find by the movie Cast
router.get("/movie-cast/:movieId", controllers_1.fetchMovieCastHandler);
// find the movie Description
router.get("/movie-description/:movieId", controllers_1.fetchMovieDescriptionHandler);
// chatting apis
// endpoint to send message to a person
router.post("/messages", controllers_1.sendMessage);
// endpoint to get the userDetails to design the chatRoom Header!
router.get("/details/:userId", controllers_1.getUserDetails);
// endpoint to fetch the messages between two users in the chatRoom!
router.get("/messages/:senderId/:recepientId", controllers_1.fetchChats);
// endpoint to delete Message from the chatRoom
router.post("/deleteMessages", controllers_1.deleteMessage);
