...
const fetchFollowing = (userID) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield userModel_1.default.findById(userID).populate('following', 'name email ');
    }
    catch (error) {
...
const sendMessageToRecipient = (senderId, recipientId, messageType, messageText, imageUrl) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendMessageToRecipient = sendMessageToRecipient;
...
const fetchChatsService = (senderId, recepientId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.fetchChatsService = fetchChatsService;
// endpoint to delete the messages between two users in the chatRoom
const deleteMessages = (messages) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Delete messages with the specified IDs
        const result = yield chatModel_1.default.deleteMany({ _id: { $in: messages } });
